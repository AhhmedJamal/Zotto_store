...
const Login = () => {
  ...
  return (
    <div className="overflow-hidden relative w-[100%] h-[100vh] m-auto flex flex-col justify-between items-center  lg:flex-row bg-primary">
      <ToastContainer />
      <div className="flex flex-col font-bold text-white mb-[130px] relative">
        <h1 className="text-[45px] text-center">ZOTTO</h1>
        <span className="self-end text-[20px] absolute -bottom-[10px]">
          Store
        </span>
      </div>
      <div className="bg-white rounded-t-[150px] scale-150 w-full  h-[350px] overflow-hidden"></div>
      <div
        className={
          "absolute bottom-[15%] w-[80%] h-[400px] gap-4 flex flex-col justify-center items-center md:ml-8 bg-white shadow-xl rounded-2xl z-10"
        }
      >
        <div className="w-[80%]">
